#!/usr/bin/env python3
"""
Fix Paddington review count by re-scraping with extended sources.
"""
...
def fix_paddington():
    ...
    print("\n[STEP 1] Extended Reddit scraping...")
    reddit_comments = scrape_reddit_paddington(max_comments=40)
    ...
    # Also get TMDB reviews
    print(f"\n[STEP 3] Fetching TMDB reviews...")
    tmdb_reviews = get_tmdb_reviews('paddington', config)
    ...
    reviews_data = {
        ...
        "scrape_summary": {
            ...
            "note": "Extended scraping with multiple subreddits"
        }
    }
    
    output_path = "data/raw/paddington_reviews.json"
